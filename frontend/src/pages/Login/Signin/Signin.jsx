    ...
    <div className="bg-[#242424] flex items-center justify-center w-full h-svh">
      ...
      >
        ...
        <div className="flex justify-between w-full px-2">
          <label className="flex flex-row gap-2 self-start items-center">
            <input
              {...register("rememberMe", { required: true, value: "" })}
              type="checkbox"
              className={`w-4 h-4  cursor-pointer opacity-30 bg-white border-[0.8px] border-button_Strok checked:accent-primary checked:opacity-100 accent-white  rounded-sm`}
            />
            <span className={`font-medium active:text-text_base text-md`}>
              Remember me
            </span>
          </label>
          <span
